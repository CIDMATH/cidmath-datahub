...
- [ ] U1 — run_build seam · [ ] U2 — registration / `_ops` writers · [x] U3 — TableDQ (done 2026-06-22, see u3-tabledq-findings.md: query-based, ~unadopted in reference builds; needs in-memory helper → 0036) ·
      [x] U4 — vocabularies + check_conventions (done 2026-06-22, see u4-vocabularies-ci-findings.md: vintage_snapshot missing from UpdateSemantics = blocks 0034/0037; layer/access_tier unvalidated) · [ ] U5 — reference pure-logic consistency
